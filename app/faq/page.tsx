...
export const metadata = {
  title: "FAQ | Organizer1st",
  description: "Frequently asked questions about Organizer1st. Connect Stripe, create events, set up seating, and get paid.",
};
    ...
    <div className="mx-auto max-w-3xl">
      <div className="mb-12">
        ...
        <p className="mt-3 text-lg text-zinc-400">
          Frequently asked questions about Organizer1st.
        </p>
      </div>
